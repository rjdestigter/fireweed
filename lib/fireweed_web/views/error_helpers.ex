defmodule FireweedWeb.ErrorHelpers do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FireweedWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FireweedWeb.Gettext, "errors", msg, opts)
    end
  end
end
